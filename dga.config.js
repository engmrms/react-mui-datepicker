export const dgaToken = {
    ...
    link: {
        primary: {
            DEFAULT: 'var(--link-primary)',
            hovered: 'var(--link-primary-hovered)',
            pressed: 'var(--link-primary-pressed)',
            focused: 'var(--link-primary-focused)',
            visited: 'var(--link-primary-visited)',
        },
        neutral: {
            DEFAULT: 'var(--link-neutral)',
            hovered: 'var(--link-neutral-hovered)',
            pressed: 'var(--link-neutral-pressed)',
            focused: 'var(--link-neutral-focused)',
            visited: 'var(--link-neutral-visited)',
        },
        oncolor: {
            DEFAULT: 'var(--link-oncolor)',
            hovered: 'var(--link-oncolor-hovered)',
            pressed: 'var(--link-oncolor-pressed)',
            focused: 'var(--link-oncolor-focused)',
            visited: 'var(--link-oncolor-visited)',
            disabled: 'var(--link-oncolor-disabled)',
        },
        error: {
            DEFAULT: 'var(--link-error)',
            hovered: 'var(--link-error-hovered)',
            pressed: 'var(--link-error-pressed)',
            focused: 'var(--link-error-focused)',
            visited: 'var(--link-error-visited)',
        },
        secondary: {
            DEFAULT: 'var(--link-secondary)',
            hovered: 'var(--link-secondary-hovered)',
            pressed: 'var(--link-secondary-pressed)',
            focused: 'var(--link-secondary-focused)',
            visited: 'var(--link-secondary-visited)',
        },
        tertiary: {
            DEFAULT: 'var(--link-tertiary)',
            hovered: 'var(--link-tertiary-hovered)',
            pressed: 'var(--link-tertiary-pressed)',
            focused: 'var(--link-tertiary-focused)',
            visited: 'var(--link-tertiary-visited)',
        },
        icon: {
            neutral: {
                hovered: 'var(--link-icon-neutral-hovered)',
                pressed: 'var(--link-icon-neutral-pressed)',
                focused: 'var(--link-icon-neutral-focused)',
                visited: 'var(--link-icon-neutral-visited)',
            },
            primary: {
                hovered: 'var(--link-icon-primary-hovered)',
                pressed: 'var(--link-icon-primary-pressed)',
                focused: 'var(--link-icon-primary-focused)',
                visited: 'var(--link-icon-primary-visited)',
            },
            oncolor: {
                hovered: 'var(--link-icon-oncolor-hovered)',
                pressed: 'var(--link-icon-oncolor-pressed)',
                visited: 'var(--link-icon-oncolor-visited)',
                disabled: 'var(--link-icon-oncolor-disabled)',
            },
            error: {
                hovered: 'var(--link-icon-error-hovered)',
                pressed: 'var(--link-icon-error-pressed)',
                focused: 'var(--link-icon-error-focused)',
                visited: 'var(--link-icon-error-visited)',
            },
        },
    },
}
