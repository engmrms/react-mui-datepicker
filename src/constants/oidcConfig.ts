...
const APP_REDIRECT_URL = process.env.NODE_ENV === 'production' ? 'https://edugate-stg.moe.gov.sa/dashboard' : 'https://localhost:5000/dashboard'
...
export const IDENTITY_CONFIG = {
    ...
    redirect_uri: APP_REDIRECT_URL, //The URI of your client application to receive a response from the OIDC provider.
    login: APP_AUTH_URL,
    ...
    silent_redirect_uri: APP_REDIRECT_URL, //(string): The URL for the page containing the code handling the silent renew.
    post_logout_redirect_uri: APP_REDIRECT_URL, // (string): The OIDC post-logout redirect URI.
