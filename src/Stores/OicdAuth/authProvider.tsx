...
const userManagerContextKeys = ['clearStaleState', 'querySessionStatus', 'revokeTokens', 'startSilentRenew', 'stopSilentRenew'] as const
const navigatorKeys = [
    'signinPopup',
    'signinSilent',
    'signinRedirect',
...
export const AuthProvider = (props: AuthProviderProps): JSX.Element => {
    ...
    const [userManager] = useState(() => {
        return (
            userManagerProp ??
            (UserManagerImpl ? new UserManagerImpl(userManagerSettings as UserManagerSettings) : ({ settings: userManagerSettings } as UserManager))
        )
    })
    ...
    const removeUser = useCallback(userManager ? () => userManager.removeUser().then(onRemoveUser) : unsupportedEnvironment('removeUser'), [
        userManager,
        onRemoveUser,
    ])
