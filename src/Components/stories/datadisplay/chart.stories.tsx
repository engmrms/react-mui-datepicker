...
const meta: Meta<typeof ChartContainer> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: '<h4>Beautiful charts. Built using Recharts. Copy and paste into your apps..</h4>',
            },
        },
    },
}
...
export const Default: Story = {
    render: () => {
        ...
        return (
            <ChartContainer config={chartConfig} className="mx-auto my-space-07 min-h-[200px] w-[500px]">
...
export const ChartAreaInteractive: Story = {
    render: () => {
        const chartData = [
        ...
        return (
            <Card className="m-space-04 min-h-[400px] border-none !bg-transparent !shadow-none ">
