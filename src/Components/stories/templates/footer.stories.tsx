...
const meta: Meta<typeof Footer> = {
    ...
    argTypes: {
        colors: {
            description: 'The colors of the footer',
            table: {
                category: 'Appearance',
                type: { summary: 'string' },
            },
        ...
        showBasicLinks: {
            description: 'The showBasicLinks of the footer',
            table: {
                category: 'Appearance',
        ...
        showGroupLinks: {
            description: 'The showGroupLinks of the footer',
            table: {
                category: 'Appearance',
                type: { summary: 'boolean' },
            },
        ...
        socialMediaTitle: {
            description: 'The socialMediaTitle of the footer',
            table: {
                category: 'Appearance',
                type: { summary: 'string' },
            },
        ...
        socialMediaLinks: {
            description: 'The socialMediaLinks of the footer',
            table: {
                category: 'Appearance',
        ...
        groupLinks: {
            description: 'The groupLinks of the footer',
            table: {
                category: 'Appearance',
                type: { summary: 'GroupLink[]' },
            },
        },
        basicLinks: {
            description: 'The basicLinks of the footer',
            table: {
                category: 'Appearance',
                type: { summary: 'BasicLink[]' },
            },
        },
        extraLinks: {
            description: 'The extraLinks of the footer',
            table: {
                category: 'Appearance',
                type: { summary: 'ExtraLink[]' },
            },
        },
        bottomImages: {
            description: 'The bottomImages of the footer',
            table: {
                category: 'Appearance',
