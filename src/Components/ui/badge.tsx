...
const badgeVariants = cva(
    'inline-flex items-center  font-medium  transition-colors text-center focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',

    {
        variants: {
            ...
            size: {
                default: 'py-space-01 px-space-03 h-[32px] text-body-01',
                sm: 'py-space-01 px-space-02   h-[24px]  text-caption-01 ',
            },
            rounded: {
                default: 'rounded-1',
                full: 'rounded-full',
